...
function(cases, controls) {
	...
	combCC = .Call("CombineSortedVectorC", as.numeric(cases), as.numeric(controls))
	combL = .Call("FindUniqueInSortedArrayC", as.numeric(combCC))
	combZX = .Call("CombineToUniqueValueC", as.numeric(cases), as.numeric(controls), as.numeric(combL))
